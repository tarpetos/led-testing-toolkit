...
def test_create_patterns_from_config():
    with (
        mock.patch("led_testing_toolkit.scripts.generate_indication_from_parameters.FadePattern") as MockFade,
...
async def test_generate_indication_from_parameters_main():
    with (
        mock.patch("led_testing_toolkit.scripts.generate_indication_from_parameters.AppConfig") as MockConfig,
        mock.patch("led_testing_toolkit.scripts.generate_indication_from_parameters.configure_logger") as mock_log,
        mock.patch(
            "led_testing_toolkit.scripts.generate_indication_from_parameters.create_patterns_from_config"
        ) as mock_create,
...
async def test_main():
    with (
        ...
        mock.patch(
            "led_testing_toolkit.scripts.generate_indication_from_parameters.generate_indication_from_parameters_main",
