...
async def test_compare_patterns_main():
    with mock.patch("argparse.ArgumentParser.parse_args") as mock_args, \
         mock.patch("led_testing_toolkit.scripts.compare_patterns.read_measured", new_callable=mock.AsyncMock) as mock_read, \
         mock.patch("led_testing_toolkit.scripts.compare_patterns.make_indication_comparison_results", new_callable=mock.AsyncMock) as mock_make:
