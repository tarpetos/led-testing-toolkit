...
def test_fade_pattern():
    config = FadePatternConfig(
        type="fade", led_ids=[1], duration=2.0, peak_time=1.0, color=[255, 0, 0], start_time=0.0, end_time=2.0
    )
    ...
    # test peak time 0
    config0 = FadePatternConfig(
        type="fade", led_ids=[1], duration=2.0, peak_time=0.0, color=[255, 0, 0], start_time=0.0, end_time=2.0
    )
    ...
    config_fast_end = FadePatternConfig(
        type="fade", led_ids=[1], duration=1.0, peak_time=1.0, color=[255, 0, 0], start_time=0.0, end_time=2.0
    )
...
def test_keyframes_pattern():
    config = KeyframesPatternConfig(
        ...
        start_time=0.0,
        end_time=5.0,
        keyframes=[Keyframe(time=1.0, color=[255, 0, 0]), Keyframe(time=2.0, color=[0, 255, 0])],
    )
    ...
    config_0 = KeyframesPatternConfig(
        ...
        start_time=0.0,
        end_time=5.0,
        keyframes=[Keyframe(time=1.0, color=[255, 0, 0]), Keyframe(time=1.0, color=[0, 255, 0])],
    )
